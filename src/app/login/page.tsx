...
export default function LoginPage() {
    return (
        <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden text-white selection:bg-white/20">
            ...
            <div className="animate-float absolute -top-20 -left-20 h-96 w-96 rounded-full bg-purple-500/20 blur-[128px]" />
            <div className="animate-float-delayed absolute -bottom-20 -right-20 h-96 w-96 rounded-full bg-blue-500/20 blur-[128px]" />
